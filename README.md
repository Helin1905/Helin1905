<!--
**helin-chaudhari/helin-chaudhari** is a ✨ special ✨ repository because its README.md appears on your GitHub profile.
-->

<h1 align="center">Hi, I'm Helinkumar Chaudhari 👋</h1>
<h3 align="center">Cloud Computing & Software Engineer | Toronto, Canada</h3>

---

## 🧑‍💻 About Me  

I am a **Cloud Computing and Software Engineering professional** with hands-on experience in **cloud-native application development, backend systems, cybersecurity, and applied machine learning**. I am currently pursuing my **Master of Professional Studies in Informatics (Cloud Computing) at Northeastern University, Toronto (2024–2025)**.

My technical background spans **full-stack development, AI/ML pipelines, DevOps automation, and security engineering**, with practical exposure to **AWS, GCP, Azure, Docker, Kubernetes**, and modern ML frameworks. I enjoy building **scalable, secure, and data-driven systems** that bridge robust backend architectures with intelligent analytics and AI models.

I am particularly interested in **cloud infrastructure, distributed systems, AI-powered applications, and security-first engineering**.
